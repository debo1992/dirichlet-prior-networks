# -*- coding: utf-8 -*-
"""
Created on Wed Jan 29 17:51:51 2020

@author: Debo z5217412
"""
...
#        print(reduce(mul, [xx ** (aa-1) for (xx, aa) in zip(x, self._alpha)]))
...
def Simplex(alpha,alpha_ideal):
    ...
    dist = Dirichlet(alpha_ideal)
    ax = plot_dirichlet.draw_pdf_contours(axes[1], dist, alpha_ideal)   
